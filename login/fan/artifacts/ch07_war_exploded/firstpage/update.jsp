    ...
    <div class="section section-txt-img  animate" id="section1">
        <div class="wrapper charact">
            <table align="center">
                ...
                <tr>
                    <td >
                        <form action="http://localhost:8080/login/UpdatePurchaseServlet" method="get">
                            <table border="0" cellspacing="0" cellpadding="0" bgcolor="white">
                                ...
                                <%
                                    ...
                                    GetBean dd=(GetBean)datelist.get(is);
                                %>
                                <input type="hidden" size="1" name="orderid" value="<%=dd.getOrderid()%>">
                                <tr>
                                    <td> 供应商名称：</td>
                                    <td> <input type="text" size="18" name="supplier" value="<%=dd.getSupplier()%>"></td>
                                </tr>
                                <tr>
                                    <td> 电话号码：</td>
                                    <td> <input type="text" size="20" name="phone" value="<%=dd.getPhone()%>" onkeyup="this.value=this.value.replace(/\D/g, '')" oninput="if(value.length>11)value=value.slice(0,11)"></td>
                                </tr>
                                <tr>
                                    <td> 联系人：</td>
                                    <td> <input type="text" size="22" name="pername" value="<%=dd.getPername()%>"></td>
                                </tr>
                                <tr>
                                    <td>产品名称：</td>
                                    <td> <input type="text" size="20" name="proname" value="<%=dd.getProname()%>"></td>
                                </tr>
                                <tr>
                                    <td>采购数量：</td>
                                    <td> <input type="text" size="20" name="amount" value="<%=dd.getAmount()%>" onkeyup="this.value=this.value.replace(/[^\d\.]/g, '')"></td>
                                </tr>
                                <tr>
                                    <td>总价</td>
                                    <td> <input type="text" size="24" name="price" value="<%=dd.getPrice()%>" onkeyup="this.value=this.value.replace(/\D/g, '')"></td>
                                </tr>
                                <div class="xs_box">
