            ...
            <table width="900" border="0" >
                <tr>
                    <td width="16%" class="bg">
                        <a href="http://localhost:8080/login/SignalPurchaseServlet?proname=塑料">塑料</a>
                    </td>
                    <td width="16%" class="bg">
                        <a href="http://localhost:8080/login/SignalPurchaseServlet?proname=橡胶">橡胶</a>
                    </td>
                    <td width="16%" class="bg">
                        <a href="http://localhost:8080/login/SignalPurchaseServlet?proname=油漆">油漆</a>
                    </td>
                    <td width="16%" class="bg">
                        <a href="http://localhost:8080/login/SignalPurchaseServlet?proname=涂料">涂料</a>
                    </td>
                    <td width="16%" class="bg">
                        <a href="http://localhost:8080/login/SignalPurchaseServlet?proname=陶瓷">陶瓷</a>
                    </td>
                    <td width="16%" class="bg">
                        <a href="http://localhost:8080/login/SignalPurchaseServlet?proname=其他">其他</a>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table width="900" border="1" bgcolor="#95BDFF">
            ...
            <%
                ...
                for(int i=datelist.size()-1;i>=0;i--){
                    GetBean dd=(GetBean)datelist.get(i);
            %>
            <tr>
                <td><%=dd.getOrderid()%></td>
                ...
                <td><%=dd.getAmount()%></td>
                <td><%=dd.getPrice()%></td>
                <td><a href="http://localhost:8080/login/DelPurchaseServlet?orderid=<%=dd.getOrderid()%>">删除</a></td>
                <td><a href="http://localhost:8080/login/firstpage/update.jsp?i=<%=i%>">修改</a></td>
            </tr>
            <%
                    }
                }
    ...
    <div class="section section-txt-img img-txt　animate" id="section1">
        <div class="xs_box">
            <div class="addBox" style="width:32%;left:150px">
                <input type="button" value="添加采购信息" class="btn" onClick="javascrtpt:window.location.href='http://localhost:8080/login/firstpage/add.jsp'">
            </div>
        </div>
    </div>
</div>
