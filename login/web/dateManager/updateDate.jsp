    ...
    <body bgcolor="FFFFFF">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
          <tr>
              ...
              <td width="20%">
                  <div class="action"><a href="http://localhost:8080/login/dateManager/updateDate.jsp">修改日程</a></div>
              </td>
              <td width="20%">
      ...
      <br><br>
      <form action="http://localhost:8080/login/UpdateDateServlet" method="post">
